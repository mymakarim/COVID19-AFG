...
class _HomePage2State extends State<HomePage2>
  ...
  void getUsers5(bool isLoading) async {
    var sqliteData =
        await dbProvider.getUsers(type: 'category', value: 24, limit: 3);
    if (mounted)
      setState(() {
    ...
    ApiProvider _api = new ApiProvider();
    var data = await _api.getUsers(type: "category", value: 24, limit: 3);
    if (mounted)
      setState(() {
        listData5.clear();
            ...
            if (index == 0) {
              ...
              return SizedBox(
                ...
                child: horizontalPost2(
                    listData: listData4, title: "سیاست", mycontext: context),
              );
            } else if (index == 2) {
              return SizedBox(
                height: 360,
