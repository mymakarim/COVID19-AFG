...
class _HomePage4State extends State<HomePage4>
    with AutomaticKeepAliveClientMixin<HomePage4> {
  ...
  void getUsers5(bool isLoading) async {
    var sqliteData =
        await dbProvider.getUsers(type: 'category', value: 24, limit: 4);
    if (mounted)
      setState(() {
    ...
    ApiProvider _api = new ApiProvider();
    var data = await _api.getUsers(type: "category", value: 24, limit: 4);
    if (mounted)
      setState(() {
        listData5.clear();
